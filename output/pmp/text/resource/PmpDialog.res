...
(ToolBar ToolBar1
    ...
    (Resources
        ...
        (PB_COPY.HelpText               "Copy To Clipboard")
        (PB_COPY.AttachLeft             True)
        (PB_COPY.AttachRight            True)
        (PB_COPY.AttachTop              True)
        (PB_COPY.AttachBottom           True)
        (PB_PASTE.Bitmap                "tb_paste")
        (PB_PASTE.HelpText              "Paste From Clipboard")
        (PB_PASTE.AttachLeft            True)
        (PB_PASTE.AttachRight           True)
        (PB_PASTE.AttachTop             True)
        (PB_PASTE.AttachBottom          True)
        (PB_CLEAR.Bitmap                "tb_delete")
        (PB_CLEAR.HelpText              "Clear Cell Values")
        (PB_CLEAR.AttachLeft            True)
        (PB_CLEAR.AttachRight           True)
        (PB_CLEAR.AttachTop             True)
        (PB_CLEAR.AttachBottom          True)
        (PB_FIND1.Bitmap                "tb_find")
        (PB_FIND1.HelpText              "Find/Replace")
        (PB_FIND1.AttachLeft            True)
        (PB_FIND1.AttachRight           True)
        (PB_FIND1.AttachTop             True)
        (PB_FIND1.AttachBottom          True)
        (PB_UNDO1.Bitmap                "undo")
        (PB_UNDO1.HelpText              "Undo Change")
